...
\ifdefined\DEBUG
\newcommand{\aay}[1]{\textcolor{Red}{#1}}
\newcommand{\damit}[1]{\textcolor{Green}{#1}}
  \def\rem#1{{\marginpar{\raggedright\scriptsize #1}}}
  \newcommand{\aayr}[1]{\rem{\textcolor{Red}{$\bullet$ #1}}}
  \newcommand{\damitr}[1]{\rem{\textcolor{Green}{$\bullet$ #1}}}
\else
  \newcommand{\aay}[1]{#1}
  \newcommand{\damit}[1]{#1}
  \newcommand{\aayr}[1]{}
